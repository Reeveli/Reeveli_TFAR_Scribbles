...
class mr3000_radio_dialog
{
	...
	onLoad = "if (sunOrMoon < 0.2) then {((_this select 0) displayCtrl 67676) ctrlSetText '\z\tfar\addons\backpacks\mr3000\ui\mr3000_n.paa';((_this select 0) displayCtrl 8000) ctrlSetTextColor [0.18,0.18,0.18,1]};";
