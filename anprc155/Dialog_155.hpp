...
class anprc155_radio_dialog
{
	idd = 7666;
	movingEnable = 1;
	controls[] = {"background","Rev_list","Rev_fr_1","Rev_fr_2","Rev_fr_3","Rev_fr_4","Rev_fr_5","Rev_fr_6","Rev_fr_7","Rev_fr_8","Rev_desc_1","Rev_desc_2","Rev_desc_3","Rev_desc_4","Rev_desc_5","Rev_desc_6","Rev_desc_7","Rev_desc_8","enter","channel_edit","edit","clear","prev_channel","next_channel","volume_Switch","stereo","additional","speakers"};
	controlsBackground[] = {};
	...
	onLoad = "if(sunOrMoon < 0.2) then {((_this select 0) displayCtrl 67676) ctrlSetText '\z\tfar\addons\backpacks\anprc155\ui\155_n.paa';((_this select 0) displayCtrl 8000) ctrlSetTextColor [0.12,0.12,0.12,1]};";
	...
	class Rev_fr_1: RscText
	{
		...
		y = TFAR_notebook_Y + TFAR_notebook_H * 0.36;
	...
	{
		idc = 8002;
		y = TFAR_notebook_Y + TFAR_notebook_H * 0.405;
	...
	{
		idc = 8003;
		y = TFAR_notebook_Y + TFAR_notebook_H * 0.45;
	...
	{
		idc = 8004;
		y = TFAR_notebook_Y + TFAR_notebook_H * 0.495;
	...
	{
		idc = 8005;
		y = TFAR_notebook_Y + TFAR_notebook_H * 0.535;
	...
	{
		idc = 8006;
		y = TFAR_notebook_Y + TFAR_notebook_H * 0.58;
	...
	{
		idc = 8007;
		y = TFAR_notebook_Y + TFAR_notebook_H * 0.625;
	...
	{
		idc = 8008;
		y = TFAR_notebook_Y + TFAR_notebook_H * 0.67;
	...
	class Rev_desc_1: RscEdit
	{
		...
		shadow = 0;
		style = 512;
		x = TFAR_notebook_X + TFAR_notebook_W * (0.75 + 0.47);
		y = TFAR_notebook_Y + TFAR_notebook_H * 0.36;
		w = TFAR_notebook_W * 0.195;
		h = TFAR_notebook_H * 0.03;
